...
if(isset($_SESSION['admin']) && $_SESSION['admin'] == true)
{
            ...
            <div class="col-md-2" dir="rtl"  align="center">
                ...
                <div class="list-group"  >
                    ...
                    <a href="../panel/re-mark_requests.php" class="list-group-item">مشاهده اعتراضات دانشجویان</a>
...
require("../db.php");
$id =$_REQUEST['id'];
$result = mysql_query("SELECT eteraz FROM grades WHERE id  = '$id'");
...
if (!$result) 
  ...
  خطایی در انجام عملیات درخ داده است
	...
	mysql_query("UPDATE grades SET eteraz ='1'  WHERE id = '$id' ");
