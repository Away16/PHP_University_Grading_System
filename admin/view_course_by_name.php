...
<title>مشاهده نمرات بر اساس درس</title>
</head>
<body>
            ...
            <div class="col-md-2" align="center" dir="rtl">
              <p class="lead" style="font-family:Tahoma" align="center" >منوی مدیریت</p>
                <div class="list-group"  >
                    ...
                    <a href="../admin/view_course_by_name.php" class="list-group-item active">مشاهده نمرات بر اساس درس</a>
...
include '../db.php';
    ...
    {   
        ...
        $sql = "SELECT DISTINCT  course FROM grades   ORDER BY course";
...
<form action="../admin/view_course_by_name.php">
...
هنوز هیچ نمره ای در سیستم ، توسط اساتید درج نشده است</div>  
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
<form action="../admin/">
    <input type="submit" value="بازگشت به عقب" class="btn btn-primary" >
</form>
 ...
 ';
            ...
            else
            {
                ...
                echo '
							...
							<h4 class="form-signin-heading">مشاهده نمرات درس انتخابی</h4>
		<hr class="colorgraph">	
    ...
    echo '<option value="' . $row['course'] . '">' . $row['course'] . '</option>';
                ...
                echo '<input type="submit" value="مشاهده نمرات درس انتخابی" class="btn btn-success  button-loading" />
                 </form>';
            }
        }
    }
...
$result2=mysql_query("SELECT id,st_name,st_code,ostad_name,course,grade,eteraz FROM grades where course='".$_POST['course']."'  ORDER BY course, st_name");
...
echo '<h4 class="form-signin-heading">مشاهده نمرات درس انتخابی</h4>
		<hr class="colorgraph">		
  ...
  <thead class="thead-default">
	...
	if ($test['eteraz']=="2") echo "<td width="."'10%'"."> <a href=reset.php?id=".$test['id'].">ریست وضعیت</a></td>";
	   ...
	   echo "</table>"; 
	  		 ...
	  		 echo "</table> <form action='../admin/view_course_by_name.php'>
    <input type='submit' value='بازگشت به عقب' class='btn btn-primary' >
</form>"; 
	   
	    } else { if ($num_rows==0) { echo  '  <div id="inner"  class="alert alert-info" role="alert" style="width:420px;"  align="center"   >
  <span class="glyphicon glyphicon-list" aria-hidden="true"></span>
  <span class="sr-only"></span><br><br>
هنوز هیچ نمره ای توسط اساتید برای این درس ، ثبت نشده است
</div>  
<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
