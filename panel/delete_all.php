...
<title>حذف همه نمرات دانشجویان</title>
</head>
<body>
...
{  ?>
     ...
     <div class="menur">
           ...
           <a href="../panel/delete_course_by_name.php" class="list-group-item ">حذف نمره بر اساس درس</a>          
                                     ...
                                     <a href="../panel/delete_all.php" class="list-group-item active">حذف همه نمرات دانشجویان</a>
...
<div class="alert alert-info" role="alert">             
    در صورتی که اطلاعات در اطلاعات ورودی شما مشکلی وجود دارد میتوانید در اینجا همه نمرات دانشجویان خود را حذف کنید  </div>
...
if (isset($_POST['_delete_'])){
 include("../db.php");
$result=mysql_query("DELETE FROM grades where ostad_user_id=".$_SESSION['ostad_id']);
	if (!$result){
...
'); 	
  ...
  <span class="sr-only">Error:</span> <br><br> همه اطلاعات دانشجویان شما، با موفقیت پاک شدند </div>';
			}
}
