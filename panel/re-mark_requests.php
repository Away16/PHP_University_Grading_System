...
<div class="wrapper">
            ...
            <div class="col-md-2" dir="rtl"  align="center">
                ...
                <div class="list-group"  >
                    ...
                    <a href="../panel/re-mark_requests.php" class="list-group-item active">اعتراضات بررسی نشده</a>
...
<div id="lcontainer"  align="center" style="width:94%; min-height:400px;  float:none;" >
  ...
  <?php
			...
			$result=mysql_query("SELECT * FROM grades where eteraz=1 and ostad_user_id=".$_SESSION['ostad_id']." ORDER BY course, st_name");
	...
	//  بعدا فرمی مجزا با این دستور بالایی		
			...
			if ($num_rows>0){
				echo    '
				<h4 class="form-signin-heading">تمامی اعتراضات دانشجویان</h4>
		<hr class="colorgraph">	
  ...
  <thead class="thead-default">
    ...
    <th style="text-align:center;">استاد</th>
     <th style="text-align:center;">نام درس</th>
      ...
      <th style="text-align:center;">اعتراض</th>
  </tr></thead>
			...
			while($test = mysql_fetch_array($result))
			{
				...
				if ($test['eteraz']=="1"){echo "<td width="."'10%'"."> <a href=r-edit.php?id=".$test['id'].">عملیات</a></td>";
	
	} else  echo "<td width="."'10%'".">    خیر </td>";
		
									
				echo "</tr>";
			} } else echo '<div  id="inner"  class="alert alert-success" role="alert" style="width:420px;"  align="center"  >
  <span class="glyphicon glyphicon-user" aria-hidden="true"></span>
  <span class="sr-only">Error:</span> <br><br> در حال حاضر هیچ اعتراضی توسط دانشجویان در سامانه ثبت نشده است </div>';
			mysql_close($conn);
